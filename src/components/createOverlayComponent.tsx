...
import { Component, RaxNode, RefObject, createElement, forwardRef } from 'rax';
...
export interface RaxOverlayProps {
  children?: RaxNode;
  isOpen: boolean;
...
export const createOverlayComponent = <OverlayComponent extends object, OverlayType extends OverlayElement>(
  ...
  type Props = OverlayComponent & RaxOverlayProps & {
    forwardedRef?: RefObject<OverlayType>;
  };
