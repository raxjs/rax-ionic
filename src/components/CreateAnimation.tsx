...
import { createElement, Fragment, PureComponent } from 'rax';
...
export class CreateAnimation extends PureComponent<CreateAnimationProps> {
  ...
  render() {
    ...
    return (
      <Fragment>
        {Children.map(children, ((child, id) => cloneElement(child as any, { ref: (el: any) => this.nodes.set(id, el) })))}
      </Fragment>
    );
  }
}
